...
function renderQuickGuide() {
  const items = [
    ["Wise Choice", "The default best-card view combines Kelly strength with model probability."],
...
function renderBestCard(option, variant) {
  ...
  const badgeTitle = variant === "wise_choice" ? "Wise Choice score" : variant === "best_growth" ? "Kelly percentage" : "Expected value rating";
  return `
