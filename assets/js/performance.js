...
function renderPickDetails(pick, index) {
  ...
  return `<div class="pick-detail-grid">
    ...
    <div><span title="Compares BoardWise model probability to available market prices. It is not personalized stake advice and is not a guarantee.">Signal</span><strong class="tnum">${esc(kellyPct)}</strong></div>
